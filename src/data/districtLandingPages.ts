...
export const districtLandingPages: Record<string, DistrictRecord> = {
  ...
  "bang-khae": {
    ...
    directAnswer: "WMS TRANSPORT ให้บริการรถกระบะตู้ทึบรับจ้างในเขตบางแค ครอบคลุมถนนเพชรเกษม กาญจนาภิเษก และพุทธมณฑล สาย 2 รองรับงานย้ายบ้าน ทาวน์โฮม และคอนโดมิเนียมแนวรถไฟฟ้า MRT หลักสอง ด้วยรถตู้ทึบความสูงมาตรฐาน 2.1 เมตร เข้าจอดใต้อาคารได้สะดวก พร้อมทีมงานช่วยยกของอย่างระมัดระวัง",
    ...
    localOperationalNotes: "พื้นที่บางแคมีซอยแยกย่อยและตรอกแคบหลายจุด โดยเฉพาะเพชรเกษม 63, 65 และ 81 รถตู้ทึบ WMS สามารถเข้าพื้นที่ได้อย่างคล่องตัว มีทีมงานยกของหลบหลีกสายไฟต่ำได้อย่างชำนาญการ",
    ...
    jobEvaluationFactors: [
      ...
      "จำนวนทีมงานยกของที่เหมาะสมกับปริมาณสัมภาระ"
    ],
    ...
    localFaq: [
      ...
      },
      {
        ...
        a: "รถกระบะตอนเดียวตู้ทึบของเรามีความคล่องตัวสูง สามารถเลี้ยวเข้าตรอกซอยแคบในย่านบางแคได้อย่างปลอดภัย ไม่ติดปัญหาเรื่องความยาวตัวถังเหมือนรถบรรทุกขนาดใหญ่"
      },
      {
        q: "หากต้องการย้ายของจากบางแคไปต่างจังหวัด คิดราคาอย่างไร?",
        a: "เราคำนวณราคาเริ่มต้นตามระยะทางวิ่งจริงจากพิกัดบางแคไปยังจังหวัดปลายทาง โดยไม่มีค่าใช้จ่ายแฝง สามารถทักแอดมินเพื่อประเมินราคาและเงื่อนไขตามจริงได้ตลอดเวลา"
      }
    ],
  ...
  "nong-khaem": {
    ...
    projectEvidenceIds: ["job-nk-01"],
    images: [
      {
        path: "/images/WM15.webp",
        alt: "รถกระบะตู้ทึบ WMS รับจ้างขนย้ายบ้านและทาวน์โฮมย่านหนองแขม เพชรเกษม 81",
        caption: "งานขนย้ายของเข้าบ้านใหม่โครงการจัดสรรย่านหนองแขม"
      }
    ],
    reviewEvidenceIds: ["rev-bk-01"],
    localFaq: [
      {
        ...
        a: "เราให้บริการครอบคลุมทั่วทุกซอยในเขตหนองแขม ทั้งเพชรเกษม 69, 77, 81 ถนนมาเจริญ และถนนเลียบคลองภาษีเจริญ รถกระบะตู้ทึบเข้าถึงหน้าบ้านได้ทุกโครงการครับ"
      },
      {
        q: "มีบริการคนช่วยยกของหนัก เช่น ตู้เย็นขนาดใหญ่ ที่นอน 6 ฟุต หรือไม่?",
        a: "มีพนักงานช่วยยกของมืออาชีพคอยดูแล จัดเรียงสิ่งของและใช้สายรัดตรึงในตู้ทึบอย่างแน่นหนา พร้อมพลาสติกแรปกันรอยขีดข่วนสำหรับเฟอร์นิเจอร์ชิ้นสำคัญ"
      },
      {
  ...
  "phasi-charoen": {
    ...
    directAnswer: "WMS TRANSPORT ให้บริการรถกระบะตู้ทึบรับจ้างขนย้ายในเขตภาษีเจริญ ครอบคลุมสถานีอินเตอร์เชนจ์ BTS/MRT บางหว้า ถนนเพชรเกษม ถนนราชพฤกษ์ ถนนบางแวก และถนนพุทธมณฑล สาย 1 บริการย้ายคอนโดมิเนียม อพาร์ตเมนต์ และบ้านพักอาศัยริมคลอง ด้วยรถตู้ทึบความสูง 2.1 ม. ที่เข้าจุดโหลดของใต้อาคารคอนโดได้อย่างสะดวก",
    actualServiceCapability: "ย้ายคอนโด High-rise & Low-rise ย่านสถานีบางหว้า ขนย้ายบ้านพักอาศัยย่านบางแวก และส่งมอเตอร์ไซค์ข้ามจังหวัด มีอุปกรณ์ซอฟต์บอร์ดและฟิล์มแรปป้องกันริ้วรอย",
    ...
    propertyAccessContext: "คอนโดมิเนียมรอบสถานี BTS/MRT บางหว้ามักมีระเบียบการจองลิฟต์และจุดจอดโหลดของเข้มงวด รถกระบะตู้ทึบมาตรฐานความสูง 2.1 เมตรของเราสามารถเข้าใต้อาคารได้โดยไม่ติดเพดานคานกั้น",
    ...
    projectEvidenceIds: ["job-pc-01"],
    images: [
      {
        path: "/images/WM12.webp",
        alt: "รถกระบะตู้ทึบ WMS รับจ้างย้ายคอนโดและขนของย่านภาษีเจริญ บางหว้า",
        caption: "บริการขนย้ายคอนโดมิเนียมใกล้สถานี BTS บางหว้า เขตภาษีเจริญ"
      }
    ],
    reviewEvidenceIds: ["rev-bk-01"],
    localFaq: [
...
export function isDistrictPageIndexable(record: DistrictRecord): boolean {
  ...
  return record.isIndexable === true && record.status === 'published' && record.proofScore >= 75;
}
