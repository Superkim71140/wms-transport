      ...
      <main className="grow relative bg-linear-to-b from-[#020817] via-[#04152D] to-[#061F45] text-slate-200 pb-28 md:pb-0">
        ...
        <section id="pricing" className="relative w-full max-w-full overflow-hidden px-4 sm:px-6 lg:px-8 py-12 md:py-24 z-10">
          <div className="absolute inset-0 overflow-hidden pointer-events-none hidden md:block">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[500px] bg-blue-600/7 rounded-full blur-[180px]" />
          </div>
          ...
          <div className="w-full max-w-7xl mx-auto relative z-10 min-w-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10 w-full max-w-7xl mx-auto min-w-0">
              <div className="w-full min-w-0 relative perf-card rounded-3xl p-8 hover:border-blue-400/40 flex flex-col transition-all duration-300 md:hover:-translate-y-2 hover:bg-white/5 group overflow-hidden">
                ...
                <div className="mt-auto">
                  ...
                  <a href="https://line.me/ti/p/DtICkMaDet" target="_blank" rel="noopener noreferrer" className="w-full line-btn-pulse text-white font-black text-sm py-3 px-4 rounded-2xl flex items-center justify-center gap-2 hover:-translate-y-0.5 transition-all duration-300">
                    <Image src="/images/LINE_icon.webp" alt="LINE" width={20} height={20} className="h-5 w-5 object-contain shrink-0" />
              ...
              <div className="w-full min-w-0 relative bg-linear-to-b from-blue-600/12 to-blue-900/8 backdrop-blur-sm md:backdrop-blur-xl rounded-3xl p-8 border border-blue-500/40 shadow-[0_15px_60px_rgba(59,130,246,0.2)] flex flex-col transition-all duration-300 md:hover:-translate-y-2 group overflow-hidden">
            ...
            <div className="text-center">
              <a href="https://line.me/ti/p/DtICkMaDet" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-10 py-5 text-white font-black text-lg rounded-2xl shadow-[0_0_25px_rgba(225,29,72,0.5)] transform transition-all duration-300 hover:scale-105 animate-[pulse_2s_ease-in-out_infinite] border border-red-400/50 bg-linear-to-r from-red-600 to-rose-500 hover:from-red-500 hover:to-rose-400 relative overflow-hidden shimmer-btn mb-6">
                <Image src="/images/LINE_icon.webp" alt="LINE" width={24} height={24} className="h-5 w-5 sm:h-6 sm:w-6 object-contain shrink-0 relative z-10" />
        ...
        <section id="why-choose-us" className="relative w-full max-w-full overflow-hidden px-4 sm:px-6 lg:px-8 py-12 md:py-24 z-10 section-contain">
          ...
          <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 min-w-0">
            {whyChooseUs.map((item, i) => (
              <div key={i} className="perf-card rounded-3xl p-8 flex flex-col sm:flex-row items-start gap-6 transition-all duration-300 md:hover:bg-white/5 hover:border-blue-500/30 md:hover:-translate-y-2 group font-sans">
