...
export const metadata: Metadata = {
  ...
  description: "เช็กอัตราค่าบริการส่งมอเตอร์ไซค์และบิ๊กไบค์ทั่วประเทศ อิงตามพิกัด cc ของรถ ปลอดภัยด้วยตู้ทึบกันฝนกันฝุ่น ประกันสินค้าฟรีทุกเที่ยว",
  alternates: {
    ...
    <div className="min-h-screen flex flex-col bg-[#040b15] overflow-x-hidden font-sans">
      <main className="grow relative pt-24 pb-24">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="flex justify-start mb-6">
            <Breadcrumbs
              items={[
                ...
                { name: "ขนส่งมอเตอร์ไซค์", item: "/pricing/motorcycle-transport" }
              ]}
            />
          </div>
          ...
          <IntentHero
            h1={policy.scenario}
            supporting="ล็อกรถล้อหน้าและรัดยึดพิเศษป้องกันล้มขูดขีดในรถตู้ทึบข้ามจังหวัด มีประกันภัยฟรีทุกเที่ยว"
          ...
          <div className="space-y-8">
            ...
            <div className="bg-linear-to-br from-blue-600/20 to-indigo-900/10 border border-blue-500/30 rounded-3xl p-6 sm:p-8 text-center">
              <span className="text-xs text-blue-400 font-black tracking-widest uppercase block mb-1">ราคาประเมินเริ่มต้นสำหรับรถทั่วไป (100cc-125cc)</span>
          ...
          <div className="mt-12 bg-linear-to-b from-[#071426] to-[#040B15] border border-white/10 rounded-3xl p-6 sm:p-10 text-center relative overflow-hidden">
            ...
            <h3 className="text-xl sm:text-2xl font-black text-white mb-4">ขอราคาค่าจัดส่งรถมอเตอร์ไซค์ข้ามจังหวัด</h3>
