...
export const metadata: Metadata = {
  ...
  description: "ค่าบริการขนย้ายบ้าน คอนโด อพาร์ทเม้นท์ และหอพักแบบละเอียด ประเมินราคาจริงตามปริมาณสิ่งของและชั้นอาคาร มีประกันสินค้าฟรีทุกเที่ยว",
  alternates: {
    canonical: "/pricing/moving",
  },
};

export default function PricingMovingPage() {
  const policy = pricingPolicyData.find(p => p.serviceType === "moving")!;
    ...
    <div className="min-h-screen flex flex-col bg-[#040b15] overflow-x-hidden font-sans">
      <main className="grow relative pt-24 pb-24">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="flex justify-start mb-6">
            <Breadcrumbs
              items={[
                ...
                { name: "ย้ายบ้านและคอนโด", item: "/pricing/moving" }
              ]}
            />
          </div>
          ...
          <IntentHero
            h1={policy.scenario}
            supporting="ประเมินราคาโปร่งใสตามระยะทาง ขนาดสิ่งของ และลิฟต์นิติบุคคล มีใบรับรองความถูกต้อง WMS"
            badge="MOVING SERVICE PRICE"
          ...
          <div className="space-y-8">
            ...
            <div className="bg-linear-to-br from-blue-600/20 to-indigo-900/10 border border-blue-500/30 rounded-3xl p-6 sm:p-8 text-center">
              <span className="text-xs text-blue-400 font-black tracking-widest uppercase block mb-1">ราคาประเมินเบื้องต้นเริ่มต้น</span>
              ...
              <p className="text-xs text-slate-400 font-semibold italic mt-2">
                *อัตราค่าบริการข้างต้นคิดตามจริง อัปเดตล่าสุด ณ วันที่ {policy.lastReviewedDate}
              </p>
            </div>
            ...
            <div className="perf-card rounded-2xl p-6 sm:p-8 space-y-4">
              <h3 className="text-base sm:text-lg font-black text-white flex items-center gap-2">
                ...
                <span>ปัจจัยที่อาจส่งผลกระทบต่อราคาประเมินสุดท้าย</span>
              </h3>
            ...
            <div className="perf-card rounded-2xl p-6 sm:p-8 space-y-4">
              <h3 className="text-base sm:text-lg font-black text-white">
                ข้อตกลงและข้อจำกัดก่อนเข้าดำเนินการ (Assumptions)
              </h3>
          ...
          <div className="mt-12 bg-linear-to-b from-[#071426] to-[#040B15] border border-white/10 rounded-3xl p-6 sm:p-10 text-center relative overflow-hidden">
            ...
            <h3 className="text-xl sm:text-2xl font-black text-white mb-4">ขอใบเสนอราคาย้ายคอนโด/ย้ายหอพัก</h3>
            <p className="text-slate-400 text-xs sm:text-sm max-w-md mx-auto leading-relaxed mb-6 font-semibold">
              แชร์รายละเอียดห้องพัก สิ่งของชิ้นใหญ่ และพิกัดรับส่งเพื่อให้แอดมินประเมินราคาที่สมเหตุสมผลที่สุดให้ทันที
            </p>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              >
                ...
                <span>ทักแชท LINE เพื่อประเมินราคา</span>
              </a>
              <a
                href="tel:0612402436"
