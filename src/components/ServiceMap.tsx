...
export default function ServiceMap() {
  const routes = [
    { from: "ภูเก็ต", to: "กรุงเทพฯ", type: "เส้นทางหลัก" },
    { from: "กรุงเทพฯ", to: "ภาคใต้", type: "ขนส่งด่วน" },
    { from: "กรุงเทพฯ", to: "ภาคตะวันออก", type: "ขนส่งอุตสาหกรรม" },
    { from: "ต่างจังหวัด", to: "ทั่วไทย", type: "เหมาเที่ยว" }
  ];
  ...
  return (
    <div className="w-full text-slate-200 font-sans" style={{ fontFamily: "var(--font-noto-sans-thai), sans-serif" }}>
      {/* 1. SECTION HEADER */}
      <div className="text-center mb-10 md:mb-16 relative z-10">
        ...
        <p className="text-sm sm:text-base md:text-lg text-slate-400 font-medium max-w-3xl mx-auto leading-relaxed">
          รับขนส่งทั่วไทย พร้อมเส้นทางยอดนิยมจากภูเก็ต กรุงเทพฯ และต่างจังหวัด ดูแลงานโดยทีมงานมืออาชีพ
        </p>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch relative z-10">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 shadow-[0_15px_40px_rgba(0,0,0,0.3)]">
          <div className="space-y-6">
            ...
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed font-semibold">
              เรามีรอบรถกระบะตู้ทึบสแตนด์บายให้บริการเป็นประจำในเส้นทางหลักทั่วประเทศไทย ขนของย้ายบ้าน ขนส่งรถมอเตอร์ไซค์บิ๊กไบค์อย่างปลอดภัย
            </p>
          ...
          <div className="mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-[#06C755] hover:bg-[#05B34F] text-white font-black text-sm transition-all duration-300 hover:-translate-y-0.5 min-h-[44px] shadow-[0_4px_12px_rgba(6,199,85,0.2)]"
            >
            ...
            <a
              href="tel:0612402436"
              className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-white/5 hover:bg-white/10 text-white border border-white/10 hover:border-blue-400/40 font-bold text-sm transition-all duration-300 hover:scale-[1.01] min-h-[44px]"
            >
        ...
        <div className="lg:col-span-7 flex flex-col gap-4 sm:gap-6 justify-center">
          {blocks.map((block, idx) => (
            <div 
              key={idx}
              className="bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-2xl p-5 sm:p-6 shadow-[0_10px_30px_rgba(0,0,0,0.15)] flex items-start gap-4 hover:border-blue-400/30 hover:bg-white/[0.04] transition-all duration-300 group"
            >
