  ...
  return (
    <div className={`relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 text-center z-10 ${className}`}>
      ...
      <div className="flex flex-col items-center justify-center max-w-4xl mx-auto">
        ...
        {/* Visible, Natural H1 */}
        <h1 className="font-sans text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight leading-[1.15] mb-6 drop-shadow-md">
          {h1}
        </h1>
        
        {/* Supporting statement */}
        <p className="font-sans text-sm sm:text-base md:text-lg text-slate-300 font-medium leading-relaxed max-w-2xl drop-shadow-sm">
          {supporting}
        </p>
        
        {/* Decorative separator line */}
        <div className="w-24 h-1 bg-linear-to-r from-blue-600 to-indigo-500 rounded-full mt-8 opacity-60" />
      </div>
    </div>
  );
}
