...
export default function HeroBackground() {
  ...
  return (
    <section className="relative w-full h-[68vh] md:min-h-[560px] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#020817]/40 via-transparent to-[#020817] pointer-events-none z-10" />
