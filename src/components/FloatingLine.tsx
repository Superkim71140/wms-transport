    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed z-[90] left-3 right-3 bottom-3 md:left-auto md:right-6 md:bottom-6 md:w-auto md:max-w-md pb-[env(safe-area-inset-bottom)] md:pb-0 mx-auto md:mx-0 select-none"
        >
          <div className="w-full rounded-2xl bg-[#040b15]/95 border border-white/10 backdrop-blur-2xl shadow-[0_12px_40px_rgba(0,0,0,0.45)] px-3 py-2 flex items-center justify-between gap-3 sm:gap-5">
