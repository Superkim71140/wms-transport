  ...
  const faqs = [
    {
      ...
      a: "รถกระบะตู้ทึบของ WMS TRANSPORT ได้รับการออกแบบให้มีความสูงรวมไม่เกิน 2.1 เมตร ซึ่งเป็นมาตรฐานความสูงของทางเข้าอาคารและลานจอดรถใต้อาคารคอนโดมิเนียมส่วนใหญ่ตามแนวรถไฟฟ้า BTS สายสีลมและ MRT สายสีน้ำเงิน ทำให้สามารถถอยเข้าเทียบจุดโหลดของหน้าลิฟต์บริการได้อย่างสะดวก"
    },
    {
    ...
    },
    {
      ...
      a: "เราคำนวณราคาเริ่มต้นตามระยะทางวิ่งจริงจากพิกัดรับของในฝั่งธนบุรีไปยังจุดหมายปลายทาง ไม่ว่าจะเป็นการข้ามสะพานเข้าฝั่งพระนคร หรือการวิ่งออกต่างจังหวัด (เช่น สมุทรสาคร นครปฐม หรือสายใต้) โดยแจ้งราคาและเงื่อนไขชัดเจนก่อนเริ่มงาน ไม่มีค่าใช้จ่ายแอบแฝง"
    },
    {
      q: "มีบริการพนักงานช่วยยกของด้วยหรือไม่ และต้องจองคิวล่วงหน้านานแค่ไหน?",
      a: "มีพนักงานช่วยยกของมืออาชีพ 1-4 คนคอยดูแลความปลอดภัยของสิ่งของ จัดเรียง และแรปฟิล์มกันรอยเฟอร์นิเจอร์ แนะนำให้จองคิวล่วงหน้า 1-2 วัน โดยเฉพาะช่วงวันหยุดสุดสัปดาห์หรือช่วงสิ้นเดือนเพื่อให้ตรงกับคิวจองลิฟต์ของนิติบุคคล"
    }
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-6">
                ...
                <h3 className="font-bold text-base text-slate-900 mb-2">
                  ความสูงไม่เกิน 2.1 เมตร
                </h3>
                <p className="text-xs text-slate-600 leading-relaxed">
                  เข้าจอดใต้อาคารจอดรถคอนโดมิเนียมแนวรถไฟฟ้า BTS/MRT ในฝั่งธนบุรีได้โดยไม่ติดคานกั้นความสูง เข้าเทียบหน้าลิฟต์บริการได้สะดวก
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white border border-slate-200/80 rounded-2xl overflow-hidden shadow-2xs">
                ...
                <div className="p-5">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    แรปฟิล์มป้องกันเฟอร์นิเจอร์หลัก ขนของลงลิฟต์บริการ และนำขึ้นรถตู้ทึบความสูง 2.1 ม. ใต้อาคารจอดรถได้อย่างราบรื่น
                  </p>
                </div>
              </div>
